...
public class UIUtils {
	...
	public static Thread getMainThread() {
		return WDApplication.mainThread;
	}
	...
	public static Handler getHandler() {
		return WDApplication.mainThreadHandler;
	}
	...
	public static boolean isRunInMainThread() {
		return android.os.Process.myTid() == Thread.currentThread().getId();
	}
	...
	private static void showToast(String str) {
		WDActivity frontActivity = WDActivity.foregroundActivity;
